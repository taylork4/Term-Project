...
public class Card {
    /**************************************************************************************************************************************************************************************
 	 * 
	 * The Card class sets the values for the cards to specific suits within the deck. The class also allows for the retrieval
    ...
    /**************************************************************************************************************************************************************************************
 	 * 
	 * The Card(int val, String suit) constructor sets the value of a card and the suit of a card. If the suit or
     * value passed are not an acceptable parameter value, an IllegalArgumentException is thrown. 
     * 
